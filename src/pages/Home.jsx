    ...
    <div className="min-h-screen overflow-hidden" style={{ background: C.bg }}>
      ...
      <section className="relative z-10 flex flex-col items-center px-4 pt-24 pb-20 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full mb-8"
          ...
          <span className="text-xs font-semibold tracking-widest uppercase" style={{ color: C.textMuted }}>Smart Queue System</span>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link to={createPageUrl('Institutions')}>
            <button className="group flex items-center gap-3 px-8 py-4 rounded-2xl text-base font-semibold text-white transition-all duration-300"
              style={{
              ...
              onMouseEnter={e => e.currentTarget.style.boxShadow = `0 12px 45px rgba(185,28,28,0.55), inset 0 1px 0 rgba(255,255,255,0.15)`}
              onMouseLeave={e => e.currentTarget.style.boxShadow = `0 8px 30px rgba(185,28,28,0.4), inset 0 1px 0 rgba(255,255,255,0.15)`}>
          ...
          <Link to={createPageUrl('MyAppointments')}>
            <button className="flex items-center gap-2 px-8 py-4 rounded-2xl text-base font-semibold transition-all duration-300"
              style={{
                background: 'rgba(255,255,255,0.8)',
              ...
              onMouseEnter={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.95)'; e.currentTarget.style.boxShadow = '0 8px 30px rgba(21,128,61,0.18), inset 0 1px 0 rgba(255,255,255,1)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.8)'; e.currentTarget.style.boxShadow = '0 4px 20px rgba(21,128,61,0.1), inset 0 1px 0 rgba(255,255,255,0.9)'; }}>
        ...
        <div className="flex flex-wrap justify-center gap-10 mt-16">
          {[['10K+', 'Bookings Made'], ['50+', 'Institutions'], ['< 60s', 'To Book']].map(([val, label]) => (
      ...
      <section className="relative z-10 px-4 pb-24">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-5">
          {[
            ...
            <div key={label} className="rounded-2xl p-6 transition-all duration-300"
              style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = `0 12px 50px ${glow}, 0 1px 0 rgba(255,255,255,1) inset`; }}
              onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = `0 4px 30px ${glow}, 0 1px 0 rgba(255,255,255,1) inset`; }}
            >
